package org.devdonkey.olap4j.demo;
...
public class MdxValidatorDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final String myValidQuery = 
            "SELECT " +
            "{[Drink].[Beverages].Children} " +
            "ON COLUMNS " +
            "FROM [Sales] " +
            "WHERE ([Time].[1997])";
        
        // Our other query we want to parse.
        final String myNotSoValidQuery = 
            "SELECT " +
            "{[Drink].[Beverages].Children} " +
            "ON COLUMNS " +
            "FROM [Sales] " +
            "WHERE ([Time].[Cake time!])";
        ...
        try {
            ...
            System.out.println("Query 2 -> "+ MdxValidatorDemo.getRootCause(e).getMessage());
        }
